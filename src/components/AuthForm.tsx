...
const AuthForm = () => {
  ...
  const [loginRole, setLoginRole] = useState<'customer' | 'shopkeeper' | 'admin'>('customer');
  
  // Signup form state
  const [signupName, setSignupName] = useState("");
  const [signupEmail, setSignupEmail] = useState("");
  const [signupPassword, setSignupPassword] = useState("");
  const [signupRole, setSignupRole] = useState<'customer' | 'shopkeeper'>('customer');
        ...
        <TabsContent value="login">
          <form onSubmit={handleLogin}>
            ...
            <CardContent className="space-y-4">
              ...
              <div className="space-y-2">
                <Label>I am a:</Label>
                <RadioGroup value={loginRole} onValueChange={(value) => setLoginRole(value as 'customer' | 'shopkeeper' | 'admin')}>
          ...
          <form onSubmit={handleSignup}>
            ...
            <CardContent className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <RadioGroup value={signupRole} onValueChange={(value) => setSignupRole(value as 'customer' | 'shopkeeper')}>
                  <div className="flex items-center space-x-2">
