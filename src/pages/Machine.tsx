    ...
    return (
      <div className="flex items-center justify-center min-h-screen bg-gray-100">
        <div className="text-center">
          ...
          <Button onClick={() => navigate('/shopkeeper')}>Back to Dashboard</Button>
        </div>
      </div>
    );
  }
    ...
    return (
      <div className="flex items-center justify-center min-h-screen bg-gray-100">
        <div className="text-center">
          ...
          <p className="mb-4">You don't have permission to access this machine.</p>
          <Button onClick={() => navigate('/shopkeeper')}>Back to Dashboard</Button>
        </div>
      </div>
    );
      ...
      <div className="machine-container max-w-md mx-auto bg-white rounded-lg shadow-lg overflow-hidden">
        <div className="bg-primary text-primary-foreground p-4">
          <div className="flex justify-between items-center mb-2">
            ...
            <Button variant="outline" size="sm" onClick={() => navigate('/shopkeeper')}>
              Back
            </Button>
          </div>
